...
public interface ConfigServiceDAO {
    ...
    List<ServiceLocation> getECheckLocations();
    
    List<ServiceLocation> getECurrLocations();
    
    List<ServiceLocation> getBSAccountLocations();
    
    List<ServiceLocation> getBSStockLocations();
    
    List<ServiceLocation> getBSBasicLocations();
    
    List<ServiceLocation> getBSOPLocations();
