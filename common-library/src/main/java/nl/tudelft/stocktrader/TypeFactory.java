...
public class TypeFactory {
	public static Order toOrder(OrderData data) {
		return new Order(data.getAccountID(), data.getOrderID(),data.getOrderType(),
						...
						data.getSymbol(), data.getCurrency());
	}
	...
	public static Account toAccount(AccountData accountData) {
		...
		try {
			...
			//(Calendar)data.getOpenDate().toGregorianCalendar()
			
			ret.setAccountID(accountData.getAccountID());
			ret.setBalance(BigDecimal.valueOf(accountData.getBalance()));
			ret.setCreationDate((Calendar) accountData.getCreationDate().toGregorianCalendar());
			ret.setLastLogin((Calendar)accountData.getLastLogin().toGregorianCalendar());
			ret.setLoginCount(accountData.getLoginCount());
			ret.setLogoutCount(accountData.getLogoutCount());
			ret.setOpenBalance(BigDecimal.valueOf(accountData.getOpenBalance()));
			ret.setProfileID(accountData.getProfileID());
			ret.setCurrencyType(accountData.getCurrencyType());
