...
public class Order {
    ...
    protected String currency; //extended by kathy


	public Order(int accountId, int orderId, String orderType, String orderStatus,
			Calendar openDate, Calendar completionDate, double quantity,
			BigDecimal price, BigDecimal orderFee, String symbol, String currency) {
